...
class NotificationSystem {
    ...
    createReminderNotification(appointment, timeText) {
        ...
        this.createNotification({
            ...
            type,
            title,
            message: `${appointment.cliente} • ${timeText} restante${urgencyText}`,
            data: {
    ...
    createLateNotification(appointment, delayMinutes, alertCount = 1, maxAlerts = 2) {
        ...
        this.createNotification({
            id,
            type: 'late',
            title: `Cliente em Atraso (${urgencyLevel}) - ${alertCount}/${maxAlerts}`,
            message: `${appointment.cliente} • ${atrasoFormatado} de atraso${urgencyMessage}`,
            data: {
                cliente: appointment.cliente,
                data: dataFormatada,
                hora: horaFormatada,
                ...
                servico: appointment.servico || 'Não especificado',
                delay: delayMinutes,
                delayFormatted: atrasoFormatado,
